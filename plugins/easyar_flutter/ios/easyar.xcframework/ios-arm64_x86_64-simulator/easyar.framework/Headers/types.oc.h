...
/// MEGA API Type.
/// </summary>
typedef enum easyar_MegaApiType : NSInteger
{
    /// <summary>
    /// Mega Block (CLS).
    /// </summary>
...
typedef enum easyar_MegaLandmarkFilterStatus : NSInteger
{
    /// <summary>
    /// Unknown error
    /// </summary>
...
@class easyar_MegaLandmarkFilterResult;

@class easyar_MegaLandmarkFilter;
...
@class easyar_GyroscopeResult;

@class easyar_AttitudeSensorResult;
...
@class easyar_Gyroscope;

@class easyar_Magnetometer;

typedef enum easyar_ThreeDofCameraDeviceFocusMode : NSInteger
{
    /// <summary>
    /// Auto focus mode
    /// </summary>
...
@class easyar_ThreeDofCameraDevice;

@class easyar_VisionOSARKitCameraDevice;

@class easyar_XREALCameraDevice;

@class easyar_SurfaceTrackerResult;

@class easyar_SurfaceTracker;

@class easyar_EventDumpRecorder;
...
typedef enum easyar_VideoInputFrameRecorderVideoCodec : NSInteger
{
    easyar_VideoInputFrameRecorderVideoCodec_H264 = 0,
} easyar_VideoInputFrameRecorderVideoCodec;

typedef enum easyar_VideoInputFrameRecorderCompletionReason : NSInteger
{
    easyar_VideoInputFrameRecorderCompletionReason_DiskFull = 0,
} easyar_VideoInputFrameRecorderCompletionReason;

@class easyar_VideoInputFrameRecorder;

@class easyar_VideoInputFramePlayer;

@class easyar_ImageHelper;

typedef enum easyar_InertialCameraDeviceFocusMode : NSInteger
{
    /// <summary>
    /// Auto focus mode
    /// </summary>
...
@class easyar_InertialCameraDevice;
...
@class easyar_ImageTrackerConfig;
...
typedef enum easyar_ValidationState : NSInteger
{
...
/// </summary>
typedef enum easyar_CameraModelType : NSInteger
{
    /// <summary>
...
/// </summary>
typedef enum easyar_CameraTransformType : NSInteger
{
    /// <summary>
    /// 0DOF
...
@class easyar_GyroscopeResultSink;

@class easyar_GyroscopeResultSource;

@class easyar_AttitudeSensorResultSink;

@class easyar_AttitudeSensorResultSource;

@class easyar_MagnetometerResultSink;

@class easyar_MagnetometerResultSource;
