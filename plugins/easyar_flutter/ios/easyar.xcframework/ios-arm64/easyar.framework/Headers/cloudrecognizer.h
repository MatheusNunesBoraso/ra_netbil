...
/// </summary>
void easyar_CloudRecognizer_createWithToken(easyar_String * cloudRecognitionServiceServerAddress, easyar_String * apiToken, easyar_String * cloudRecognitionServiceAppId, /* OUT */ easyar_CloudRecognizer * * Return);
/// <summary>
