...
/// </summary>
void easyar_CameraParameters_tryCreateWithCustomIntrinsics(easyar_Vec2I imageSize, easyar_ListOfFloat * cameraParamList, easyar_CameraModelType cameraModel, easyar_CameraDeviceType cameraDeviceType, int cameraOrientation, /* OUT */ easyar_OptionalOfCameraParameters * Return);
/// <summary>
...
void easyar_ListOfFloat__ctor(float const * begin, float const * end, /* OUT */ easyar_ListOfFloat * * Return);
void easyar_ListOfFloat__dtor(easyar_ListOfFloat * This);
void easyar_ListOfFloat_copy(const easyar_ListOfFloat * This, /* OUT */ easyar_ListOfFloat * * Return);
int easyar_ListOfFloat_size(const easyar_ListOfFloat * This);
float easyar_ListOfFloat_at(const easyar_ListOfFloat * This, int index);
